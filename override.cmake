...
SET(CMAKE_C_FLAGS_RELEASE_INIT "-Os -march=armv7-a -mfpu=neon  -mthumb -mthumb-interwork -mfloat-abi=softfp -DKLAATU -D_USE_MATH_DEFINES  -DUSE_ARM_NEON -DUSE_ARM_SIMD -include limits.h  --sysroot=$ENV{ANDROID_BUILD_TOP}")
...
SET(CMAKE_CXX_FLAGS_RELEASE_INIT "-Os -frtti -march=armv7-a -mfpu=neon  -mthumb -mthumb-interwork -mfloat-abi=softfp -DKLAATU -D_USE_MATH_DEFINES  -DUSE_ARM_NEON -DUSE_ARM_SIMD -include limits.h  -I$ENV{ANDROID_NDK_TOP}/sources/cxx-stl/gnu-libstdc++/4.6/include -I$ENV{ANDROID_NDK_TOP}/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi-v7a/include  -I$ENV{ANDROID_BUILD_TOP}/usr/include/bionic -DANDROID --sysroot=$ENV{ANDROID_BUILD_TOP} ")
